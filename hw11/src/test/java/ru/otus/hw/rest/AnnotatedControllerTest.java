...
@ComponentScan({"ru.otus.hw.config.test.reactiverest"})
@SpringBootTest(classes = {AnnotatedController.class},webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
